...
ermine_public unsigned char *eutil_loadfile_data(const char *filename, unsigned int *bytes);

ermine_public void etracelog(int t, const char *text, ...);

ermine_public const char *eutil_file_get_extension(const char *filename);

ermine_public bool eutil_isfile_extension(const char *filename, const char *ext);

ermine_public const char *eutil_file_get_name(const char *filepath);

ermine_public char *eutil_path_normalize(const char *path);

ermine_public int eutil_genrandom_number(int length);
...
ermine_public void ebegin_mode(ecamera cam);

ermine_public void eend_mode(void);

ermine_public ecamera ecamera_make(void);

ermine_public void erender_camera_set_viewport(ecamera *cam, int x, int y, int w, int h, bool scissor);
